        ...
        <div className="mx-auto max-w-content px-6 py-14 md:py-20 grid md:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          <div className="md:col-span-5">
            <div className="relative aspect-[4/5] overflow-hidden bg-cream">
              <Image src="/images/founder-scene.png" alt="TerraDebt founder" fill className="object-cover" sizes="(max-width: 768px) 100vw, 40vw" />
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="md:col-span-8">
              ...
              <div className="mt-8 pt-6 border-t border-rule">
                ...
                <p className="mt-3 text-sm text-muted leading-relaxed max-w-2xl">
                  TerraDebt coordinates licensed counsel in all 50 states for legal defense work. The attorney roster is engagement-specific and disclosed to the merchant at intake.
                </p>
              </div>
            </div>
          </div>
