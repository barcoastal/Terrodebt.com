    ...
    <article className="mx-auto max-w-content px-6 py-16 space-y-24">
      ...
      <Section number="01" title="Logo system" description="The Freshline Advisory mark is a geometric T inside a black square, paired with the wordmark in Geist Bold. The emerald green dot is the brand's signal element. It always appears.">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <LogoCard label="Wordmark on dark" file="/logos/freshline-wordmark-white.svg" bg="bg-slate" />
          <LogoCard label="Wordmark monochrome" file="/logos/freshline-wordmark.svg" bg="bg-offwhite" tint />
          <LogoCard label="Icon mark (slate)" file="/logos/freshline-icon.svg" bg="bg-white" small />
          <LogoCard label="Icon mark (light, on dark)" file="/logos/freshline-icon.svg" bg="bg-slate" small />
        </div>
