...
const TERMS: Omit<GlossaryEntry, "slug">[] = [
  {
    ...
    related: { label: "MCA Debt Relief", href: "/services/debt-relief-planning" },
  },
  {
    term: "Acceleration",
    definition:
    ...
    related: { label: "Bank Loan Workouts", href: "/services/debt-relief-planning" },
  },
  {
  ...
  },
  {
    ...
    related: { label: "Equipment Finance Restructure", href: "/services/debt-relief-planning" },
  },
  {
    term: "Cross-default",
    definition:
  ...
  },
  {
    ...
    related: { label: "Business Tax Debt", href: "/services/debt-relief-planning" },
  },
  {
    term: "Lien",
    definition:
  ...
  },
  {
    ...
    related: { label: "Vendor and Supplier Debt", href: "/services/debt-relief-planning" },
  },
  {
    term: "Modification",
    definition:
