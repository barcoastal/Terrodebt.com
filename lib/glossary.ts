...
const TERMS: Omit<GlossaryEntry, "slug">[] = [
  {
    ...
    related: { label: "MCA Debt Relief", href: "/services/business-debt-resolution" },
  },
  {
    term: "Acceleration",
    definition:
    ...
    related: { label: "Bank Loan Workouts", href: "/services/business-debt-resolution" },
  },
  {
  ...
  },
  {
    ...
    related: { label: "Equipment Finance Restructure", href: "/services/business-debt-resolution" },
  },
  {
    term: "Cross-default",
    definition:
  ...
  },
  {
    ...
    related: { label: "Business Tax Debt", href: "/services/business-debt-resolution" },
  },
  {
    term: "Lien",
    definition:
  ...
  },
  {
    ...
    related: { label: "Vendor and Supplier Debt", href: "/services/business-debt-resolution" },
  },
  {
    term: "Modification",
    definition:
