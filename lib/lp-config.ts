...
export const LP_CONFIGS: Record<string, LpConfig> = {
  google: {
    id: "google",
    source: "google-lp",
    metaTitle: "Business Debt Restructure - Free Assessment | Freshline Advisory",
  ...
  affiliate: {
    id: "affiliate",
    source: "affiliate-lp",
    metaTitle: "Resolve Business Debt with a Coordinated Workout | Freshline Advisory",
    ...
    eyebrow: "Referred to Freshline Advisory",
    headlineLead: "Resolve your business debt with a",
    headlineAccent: "real plan",
    headlineTail: ".",
    subline:
      "Freshline Advisory builds a workout that fits your situation. MCA, SBA, equipment, vendor, bank, and tax debt. Coordinated end to end.",
    bullets: [
