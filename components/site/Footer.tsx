    ...
    <footer className="mt-24 border-t border-rule bg-offwhite">
      <div className="mx-auto max-w-content px-6 py-14 grid gap-10 md:grid-cols-12 text-sm">
        <div className="md:col-span-3">
          ...
          <p className="text-muted leading-relaxed">The business debt brief, written by operators.</p>
        ...
        <div className="md:col-span-3">
          <div className="font-mono text-[11px] uppercase tracking-wider text-muted mb-3">Topic areas</div>
          <ul className="space-y-2 text-slate">
            {PRODUCTS.map((p) => (
              <li key={p.slug}>
