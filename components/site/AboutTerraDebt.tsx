...
export function AboutTerraDebt() {
  return (
    <section className="bg-offwhite">
      <div className="mx-auto max-w-content px-6 py-20 md:py-24 grid md:grid-cols-12 gap-10 lg:gap-14 items-start">
        ...
        <div className="md:col-span-7">
          <span className="font-mono text-[11px] uppercase tracking-wider text-muted">About</span>
          <h2 className="mt-2 font-bold tracking-tighter text-slate text-3xl md:text-4xl lg:text-5xl leading-tight">
            About TerraDebt.
          </h2>
          <div className="mt-7 space-y-5 text-slate leading-relaxed max-w-2xl">
            <p>
              TerraDebt is the company we wished existed when we were on the operating side. The relief category looks like 2018 and acts like it: scare tactics, single-product pitches, and a sales script that pitches before it listens. We do the work differently.
            </p>
            <p>
